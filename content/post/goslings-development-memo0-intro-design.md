...
[Gitのリポジトリの中身](https://tbd.kaitoy.xyz/2015/12/27/git-repository/)をビジュアライズするWebアプリケーションだ。
...
このビューでの表示は[以前Gitリポジトリの中身を解説した記事](https://tbd.kaitoy.xyz/2015/12/27/git-repository/)に合わせた。
