...
前者の方が当然クライアントの負荷が軽くなるが、[__Pygments__](http://pygments.org/)のインストールが必要だったりめんどくさそうなので後者にする。(Pygmentsは[Jekyllのとき](http://tbd.kaitoy.xyz/2015/08/15/github-pages-and-jekyll/)にすでに入れたけど…)
...
ここでは、`git init`でblogフォルダをGitレポジトリにして、`git submodule add`で__hugo_theme_robust__ (RobustのGitHubプロジェクト)を[サブモジュール](https://git-scm.com/book/ja/v1/Git-%E3%81%AE%E3%81%95%E3%81%BE%E3%81%96%E3%81%BE%E3%81%AA%E3%83%84%E3%83%BC%E3%83%AB-%E3%82%B5%E3%83%96%E3%83%A2%E3%82%B8%E3%83%A5%E3%83%BC%E3%83%AB)として追加している。
こうすることで、blogとhugo_theme_robustを別々のレポジトリとして管理しつつ、hugo_theme_robustをblogの一部として使うことができる。
...
## GitHubへソースを保存
blog内の変更をコミットして、GitHubにblogという名のレポジトリを作成して、以下のコマンドでソースをアップロードする。
...
因みにgh-pagesは、[以前のエントリ](http://tbd.kaitoy.xyz/2015/08/15/github-pages-and-jekyll/#github-pages%E5%91%B3%E8%A6%8B)にも書いたが、GitHub Pagesで公開するサイトを置く特別なブランチ。
